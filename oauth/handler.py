...
class OAuthCodeExchangeHandler(OAuthBaseRequestHandler):
  ...
  def _perform_post_auth_tasks(self, userid, creds):
    ...
    if hostname.startswith('https://'):
      ...
      contact_body = {
          'id': 'Auto French Press',
          'displayName': 'Auto French Press',
          'imageUrls': [util.get_full_url(self, '/static/images/FrenchPress.jpg')]
      }
    ...
    timeline_item_body = {
        'text': 'Welcome to The Automatic French Press',
        'notification': {
            'level': 'DEFAULT'
        }
    }
